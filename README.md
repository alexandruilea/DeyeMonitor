...
| `HIGH_LOAD_KW`                 | House load threshold that triggers pause / sell cutoff (kW)           | 6.0     |
| `HIGH_LOAD_HOLD_MIN`           | Minutes load must stay above/below threshold before switching         | 5.0     |
